...
public class FightState extends State{
	...
	public FightState(Display display, Screen screen, MouseManager mouseManager) {
		this.display = display;
		this.uiManager = new UIManager(this.display);
		this.mouseManager = mouseManager;
		this.screen = screen;
		UIBox playerButtons = new UIBox(20.0D, 40.0D, 300, 300, this.screen);
		UIImageButton attackButton = new UIImageButton(50.0D, 50.0D, 32, 32, this.screen, Assets.attackIcon);
	}
